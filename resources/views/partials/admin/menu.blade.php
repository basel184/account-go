...
// }
$logo=
\App\Models\Utility::get_file('uploads/logo/');
                ...
                @if( Gate::check('manage proposal') ||  (Gate::check('manage retainer')))
                    ...
                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'proposal' || Request::segment(1) == 'retainer')?' active dash-trigger':''}}">
                        ...
                        <ul class="dash-submenu {{ (Request::segment(1) == 'proposal' || Request::segment(1) == 'retainer')?'show':''}}">
                            @can('manage proposal')
                                <li class="dash-item {{ (Request::route()->getName() == 'proposal.index' || Request::route()->getName() == 'proposal.create' || Request::route()->getName() == 'proposal.edit') ? ' active' : '' }}">
