...
<body class="<?php echo e($color); ?>" dir="<?php echo e($SITE_RTL == 'on'?'rtl':''); ?>">
<!-- [ Nav ] start -->
        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-5">
                <h1
                    ...
                    data-wow-delay="0.2s"
                >
                    <?php echo e(__('AccountGo SaaS')); ?>

                </h1>
                <h2
                    class="text-white mb-sm-4 wow animate__fadeInLeft"
                    data-wow-delay="0.4s">
                   <?php echo e(__('Accounting and Billing Tool')); ?>
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    ...
                    >
                    <a href="https://codecanyon.net/item/accountgo-saas-accounting-and-billing-tool/25733019?s_rank=27" class="btn btn-outline-light" target="_blank"
...
<section class="side-feature">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-sm-9 col-lg-6 col-md-12 col-sm-12">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 text-end">
                <p class="text-body"><?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright AccountGo SaaS')); ?> <?php echo e(date('Y')); ?></p>
            </div>
        </div>
    </div>
</section>
...
<?php /**PATH C:\Users\Administrator\Desktop\account-go\resources\views/layouts/landing.blade.php ENDPATH**/ ?>