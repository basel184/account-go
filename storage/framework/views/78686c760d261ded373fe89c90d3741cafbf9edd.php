...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(array('url' => 'retainer','class'=>'w-100'))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                <?php echo e(Form::select('customer_id', $customers,$customerId, array('class' => 'form-control select','id'=>'customer','data-url'=>route('proposal.customer'),'required'=>'required'))); ?>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('retainer_number', __('Retainer Number'),['class'=>'form-label'])); ?>

                                        <div class="form-icon-user">
                                            <input type="text" class="form-control" value="<?php echo e($retainer_number); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="col-md-6">
                                    <div class="custom-control custom-checkbox mt-4">
                                        ...
                                        <label class="custom-control-label form-label" for="discount_apply"><?php echo e(__('Apply Discount')); ?></label>
                                    </div>
                                </div> -->
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
        ...
        <div class="modal-footer">
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route("retainer.index")); ?>';" class="btn btn-light">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Downloads\AccountGo\main_file\resources\views/retainer/create.blade.php ENDPATH**/ ?>