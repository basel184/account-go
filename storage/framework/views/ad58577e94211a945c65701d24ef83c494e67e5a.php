                        ...
                        <div class="col-lg-3 col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-0 text-primary"><?php echo e(\Auth::user()->countCustomers()); ?>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-0 text-info"><?php echo e(\Auth::user()->countVenders()); ?>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-0 text-warning"><?php echo e(\Auth::user()->countInvoices()); ?> </h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h3 class="mb-0 text-danger"><?php echo e(\Auth::user()->countBills()); ?> </h3>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($invoice->status == 0): ?>
                                                    <span class="p-2 px-3 fix_badges rounded badge bg-secondary"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                <?php elseif($invoice->status == 1): ?>
                                                    <span class="p-2 px-3 fix_badges rounded badge bg-warning"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                <?php elseif($invoice->status == 2): ?>
                                                    <span class="p-2 px-3 fix_badges rounded badge bg-danger"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                <?php elseif($invoice->status == 3): ?>
                                                    <span class="p-2 px-3 fix_badges rounded badge bg-info"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                <?php elseif($invoice->status == 4): ?>
                                                    <span class="p-2 px-3 fix_badges rounded badge bg-success"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <div class="card" style="height: 396px">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills mb-5" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-Dashboard-tab" data-bs-toggle="pill" href="#invoice_weekly_statistics" role="tab" aria-controls="pills-home" aria-selected="true"><?php echo e(__('Invoices Weekly Statistics')); ?></a>
                                </li>
                                <li class="nav-item">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($bill->status == 0): ?>
                                                    <span class="p-2 px-3 fix_badge rounded badge bg-secondary"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                <?php elseif($bill->status == 1): ?>
                                                    <span class="p-2 px-3 fix_badge rounded badge bg-warning"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                <?php elseif($bill->status == 2): ?>
                                                    <span class="p-2 px-3 fix_badge rounded badge bg-danger"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                <?php elseif($bill->status == 3): ?>
                                                    <span class="p-2 px-3 fix_badge rounded badge bg-info"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                <?php elseif($bill->status == 4): ?>
                                                    <span class="p-2 px-3 fix_badge rounded badge bg-success"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                ...
                                                <span>
                                                    <span class="row align-items-center mt-3">
                                                        ...
                                                        <span class="col">
                                                            ...
                                                            <h6 class="mb-3 mb-sm-0"><?php echo e(number_format($goal->target($goal->type,$goal->from,$goal->to,$goal->amount)['percentage'], Utility::getValByName('decimal_number'), '.', '')); ?>%</h6>
                                                            <div class="progress mb-0">
                                                                <div class="progress-bar bg-primary"  style="width: <?php echo e(number_format($goal->target($goal->type,$goal->from,$goal->to,$goal->amount)['percentage'], Utility::getValByName('decimal_number'), '.', '')); ?>%"></div>
                                                            </div>
                                                        </span>
                                                    </span>
                                                </span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\account-go\resources\views/dashboard/index.blade.php ENDPATH**/ ?>