...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create transfer')): ?>
            <a href="#" data-url="<?php echo e(route('transfer.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create Transfer')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" class="btn btn-sm btn-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="#" class="btn btn-sm btn-primary" onclick="document.getElementById('transfer_form').submit(); return false;" data-bs-toggle="tooltip"  title="Apply" data-original-title="<?php echo e(__('apply')); ?>">
                                    <span class="btn-inner--icon"><i class="ti ti-search"></i></span>
                                </a>

                                <a href="<?php echo e(route('transfer.index')); ?>" class="btn btn-sm btn-danger" data-bs-toggle="tooltip"
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit transfer')): ?>
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="<?php echo e(route('transfer.edit',$transfer->id)); ?>" data-ajax-popup="true" title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Transfer')); ?>" data-bs-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Downloads\AccountGo\main_file\resources\views/transfer/index.blade.php ENDPATH**/ ?>