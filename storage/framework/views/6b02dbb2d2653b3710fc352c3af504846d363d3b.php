...
unset($__errorArgs, $__bag); ?>
        ...
        <?php elseif(\Auth::user()->type == 'super admin'): ?>
            <?php echo Form::hidden('role', 'company', null,array('class' => 'form-control select','required'=>'required')); ?>
...
<?php /**PATH C:\Users\pc\Downloads\AccountGo\main_file\resources\views/user/create.blade.php ENDPATH**/ ?>