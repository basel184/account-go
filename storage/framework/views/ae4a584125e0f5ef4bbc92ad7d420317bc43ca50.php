...
unset($__errorArgs, $__bag); ?>
        ...
        <?php if($settings['enable_signup'] == 'on'): ?>
            <p class="my-4 text-center"><?php echo e(__("Don't have an account?")); ?> <a href="<?php echo e(route('register')); ?>" class="text-primary"><?php echo e(__('Register')); ?></a></p>
        <?php endif; ?>

        <div class="row">
            <div class="col-sm-6">
                <a href="<?php echo e(route('customer.login')); ?>" class="btn-login btn btn-primary btn-block mt-2 text-white"><?php echo e(__('Customer Login')); ?></a>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Downloads\AccountGo\main_file\resources\views/auth/login.blade.php ENDPATH**/ ?>