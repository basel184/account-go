...
<?php $__env->startSection('auth-lang'); ?>
    ...
    <select name="language" id="language" class="btn btn-primary my-1 me-2" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
        <?php $__currentLoopData = App\Models\Utility::languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option <?php if($lang == $language): ?> selected <?php endif; ?> value="<?php echo e(route('vender.login.lang',$language)); ?>"><?php echo e(Str::upper($language)); ?></option>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo e(Form::open(array('route'=>'vender.login','method'=>'post','id'=>'loginForm'))); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mb-4">
                <a href="<?php echo e(route('vender.change.langPass')); ?>" class="text-xs"><?php echo e(__('Forgot Your Password?')); ?></a>
        </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Downloads\AccountGo\main_file\resources\views/auth/vender_login.blade.php ENDPATH**/ ?>